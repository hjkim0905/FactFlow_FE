	...
	return (
		<>
			<div
				...
				style={{ background: "#2C2C2C", height: "343px", maxWidth: "100%" }}
			>
			...
			<div
				className="w-full bg-[#0073FF] flex items-center relative"
				style={{ height: "6.8125rem" }}
			>
				<div>
					<span
					...
					>
						여러분의 뉴스 리터러시를 길러줄 ‘
						<span style={{ color: "#F8FF69" }}>뉴기</span>’에요.
						<br />
