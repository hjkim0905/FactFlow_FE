...
export default function CoreSummary({ summary, three_sentences, difficulty }: CoreSummaryProps) {
    ...
    return (
        <div className="p-6 text-black">
            ...
            <div className="relative">
                <div className="bg-[#0073FF] shadow-[0px_1.61161px_1.61161px_rgba(0,0,0,0.25)] rounded-[0.403rem] w-[19.5rem] h-[6.375rem] p-4 text-white -mt-7.5">
                    {three_sentences ? (
